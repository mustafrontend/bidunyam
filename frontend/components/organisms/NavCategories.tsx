...
const NAV_ITEMS: NavItem[] = [
  {
    label: "Giyim",
    href: `/arama?kategori=${encodeURIComponent("Giyim")}`,
    paramValue: "Giyim",
  ...
  {
    label: "Ev & Yaşam",
    href: `/arama?kategori=${encodeURIComponent("Ev & Yaşam")}`,
    paramValue: "Ev & Yaşam",
  ...
  {
    label: "Elektronik",
    href: `/arama?kategori=${encodeURIComponent("Elektronik")}`,
  ...
  {
    label: "Bebek & Çocuk",
    href: `/arama?kategori=${encodeURIComponent("Bebek & Çocuk")}`,
  ...
  {
    label: "Kozmetik",
    href: `/arama?kategori=${encodeURIComponent("Kozmetik")}`,
    paramValue: "Kozmetik",
  ...
  {
    label: "Spor & Outdoor",
    href: `/arama?kategori=${encodeURIComponent("Spor & Outdoor")}`,
